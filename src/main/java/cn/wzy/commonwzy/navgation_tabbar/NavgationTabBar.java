package cn.wzy.commonwzy.navgation_tabbar;
...
public class NavgationTabBar extends LinearLayout implements View.OnClickListener {
    ...
    public NavgationTabBar(Context context) {
        this(context, null);
    }

    public NavgationTabBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NavgationTabBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mNormalTextColor = (tabTextColor != null ? tabTextColor : context.getResources().getColorStateList(R.color.main_color));
